        ...
        <div class="overflow-x-auto">
            <table class="table-bordered w-full border">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>SLA:</th>
                        <td colspan="3"><date-locale datetime="{{ $ticket->sla_dt }}" /></td>
                    </tr>
                    <tr>
                        <th>Working Time:</th>
                        <td colspan="3"><time-locale minutes="{{ $ticket->working_time }}" /></td>
                    </tr>
                    <tr>
                        <th>Descriptions:</th>
                    ...
                    <tr>
                        <th>Created At:</th>
                        <td><date-locale datetime="{{ $ticket->created_at }}" /></td>
                        <th>Created By:</th>
                    ...
                    <tr>
                        <th>Updated At:</th>
                        <td><date-locale datetime="{{ $ticket->updated_at }}" /></td>
                        <th>Updated By:</th>
